...
impl AsTable for ItemDetail {
    fn to_table(&self) -> Table {
        ...
        table.add_row(row!["Date", table::format_date_opt(&self.item_date)]);
        table.add_row(row!["Due", table::format_date_opt(&self.due_date)]);
        table.add_row(row!["Created", table::format_date(self.created)]);
        table.add_row(row![
            "Correspondent",
